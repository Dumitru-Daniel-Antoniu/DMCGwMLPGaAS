...
def compute_metrics(eval_pred):
    ...
    # In case the model returns (logits,) as a tuple
...
def main():
    ...
    # Same limits as your UnixCoder script
    ...
    trainer.save_model("./codebert-finetuned")
    tokenizer.save_pretrained("./codebert-finetuned")
    print("Model saved to ./codebert-finetuned")
